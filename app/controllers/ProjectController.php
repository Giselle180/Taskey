...
class ProjectController
{
    ...
    {
        $project = $this->taskRepository->all();
        return $this->responseFactory->view("project/index.html.twig", ['task' => $project]);
    }
    ...
    public function update(Request $request): Response
    {
        ...
        $taskUpdate = $this->taskRepository->update($project);
        if ($taskUpdate) {
            return $this->responseFactory->internalError();
        }
    ...
    public function delete(Request $request): Response
    {
        ...
        return $this->responseFactory->redirect('/project');
    }
}
